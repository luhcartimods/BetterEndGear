...
public enum ModArmorMaterials implements ArmorMaterial {
    BLAZE_SCALE("blaze_scale", 26, new int[]{ 3, 7, 5, 3 }, 25, SoundEvents.BLAZE_AMBIENT, 3f, 0.1f, () -> Ingredient.of(ModItems.ENDER_RELICS.get()));
    ...
    private static final int[] BASE_DURABILITY = { 399, 584, 550, 470 };
    ...
    public String getName() {
        return BetterEndGear.MOD_ID + ":" + this.name;
    }
